...
Bayesian Dynamic Borrowing with covariate adjustment for simulations and data analyses in 
clinical trials.
...
calculated for each subject. Propensity scores are essential in order to balance covariates between 
internal and external trial participants.
