...
#include "stanExports_weibull-pwr-prior.h"

RCPP_MODULE(stan_fit4weibull-pwr-prior_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_weibull-pwr-prior")
