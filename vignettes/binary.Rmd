...
We define our marginal treatment effect to be the difference between the active treatment response rate and the control response rate (i.e., $\theta_T - \theta_E$). We can obtain a sample from the posterior distribution for $\theta_T - \theta_E$ by subtracting the posterior sample of $\theta_C$ from the posterior sample of $\theta_T$.
