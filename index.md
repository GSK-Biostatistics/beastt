# beastt [![beastt logo](reference/figures/beastt_hex.png)](https://gsk-biostatistics.github.io/beastt/)
...
If you are looking to conduct a simulation study for a binary or
time-to-event endpoint, you can use the template code available
